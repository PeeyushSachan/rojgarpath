...
const railwayGroups = [
    { name: 'RRB NTPC', posts: [
        railwayPost('RRB NTPC', 'ntpc', {
            overview: 'RRB NTPC is a major recurring Railway recruitment route for undergraduate and graduate non-technical posts. Exact post-wise eligibility, medical categories, and stages are defined in the applicable CEN.',
            qualification: 'Undergraduate and graduate NTPC posts have different qualification requirements. Check the current CEN for post-wise criteria.',
            profile: 'NTPC includes commercial, clerical, accounts and operations-support posts across Railway units as notified.',
            pay: 'Pay level and allowances are post-specific under the current NTPC CEN.',
        }),
    ...
    { name: 'RRB GROUP D', posts: [
        railwayPost('RRB Group D (Level 1)', 'level1', {
            overview: 'RRB Group D (Level 1) is a high-demand recurring Railway recruitment route for operational and field support roles. Post-wise conditions are governed by the current Level-1 CEN.',
            qualification: 'Qualification, age, and medical requirements must be verified from the active Level-1 notification.',
            profile: 'Level-1 posts include track, station and assistant support duties according to allocated department and unit.',
            pay: 'Level-1 pay and allowances are as per current CEN and Railway service rules.',
            searchText: 'RRB Group D Level 1 Railway Group D',
        }),
        railwayPost('Track Maintainer Grade IV', 'level1', { searchText: 'Track Maintainer Grade IV RRB Group D' }),
        railwayPost('Pointsman', 'level1', { searchText: 'Pointsman RRB Group D' }),
        railwayPost('Assistant / Assistant Pointsman', 'level1', {
            overview: 'Assistant and Assistant Pointsman entries are commonly searched Group D support routes. Exact role mapping depends on the post names notified in the active Level-1 CEN.',
            searchText: 'Assistant Pointsman RRB Group D Assistant',
        }),
    ] },
    { name: 'RRB ALP & TECHNICIAN', posts: [
